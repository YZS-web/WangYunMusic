package com.WangYun.music.utils;

import android.os.Message;
import android.util.Log;

import com.WangYun.music.api.Api;
import com.WangYun.music.control.Result;
...
public class MenuList {
    ...
    public static List<com.WangYun.music.domain.MusicListInfo> sMusicListInfo;
    ...
    private void updateInfo() {
        ...
        sMusicListInfo = new ArrayList<com.WangYun.music.domain.MusicListInfo>();
        mNum = 0;
        for (int i = 0; i < sCount; i++) {
            com.WangYun.music.domain.MusicListInfo mMusicListInfo = new com.WangYun.music.domain.MusicListInfo();
