...
import com.WangYun.music.adapter.TopListAdapter;
import com.WangYun.music.utils.GetMenuList;
import com.WangYun.music.utils.LikeCRUD;
import com.WangYun.music.utils.GetTopList;
...
public class Main extends AppCompatActivity {
    ...
    public void like(View view){
        if(new LikeCRUD().likeSelete(getApplicationContext(),10)){
            ...
            intent.putExtra("Tag","我喜欢");
            intent.putExtra("keyword","");
            startActivity(intent);
        }else {
            Toast.makeText(this, "我喜欢为空", Toast.LENGTH_SHORT).show();
        }
    }
