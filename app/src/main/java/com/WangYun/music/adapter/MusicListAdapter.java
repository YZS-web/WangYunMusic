package com.WangYun.music.adapter;
...
public class MusicListAdapter extends RecyclerView.Adapter<MusicListAdapter.InnerHolder>{
    ...
    List<com.WangYun.music.domain.MusicListInfo> mMusicListInfo = new ArrayList<com.WangYun.music.domain.MusicListInfo>();
    ...
    public void onBindViewHolder(@NonNull InnerHolder holder, int position) {
        com.WangYun.music.domain.MusicListInfo musicListInfo = mMusicListInfo.get(position);
